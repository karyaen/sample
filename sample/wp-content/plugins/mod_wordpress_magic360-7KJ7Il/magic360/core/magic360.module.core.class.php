...
if(!defined('Magic360ModuleCoreClassLoaded')) {
    ...
    class Magic360ModuleCoreClass {
        ...
        function getHeadersTemplate($jsPath = '', $cssPath = null) {
            ...
            $headers = array();
            // add module version
            $headers[] = '<!-- Magic 360 WordPress module version v6.1.31 [working:v4.6.4] -->';
        ...
        function loadDefaults() {
            $params = array(
				"rows"=>array("id"=>"rows","group"=>"Magic 360","order"=>"0","default"=>"1","label"=>"Number of images on Y-axis {row}","type"=>"num","scope"=>"magic360"),
				...
				"class"=>array("id"=>"class","group"=>"Miscellaneous","order"=>"20","default"=>"Magic360","label"=>"Class Name","type"=>"array","subType"=>"select","values"=>array("all","Magic360"),"scope"=>"module"),
				"show-message"=>array("id"=>"show-message","group"=>"Miscellaneous","order"=>"150","default"=>"No","label"=>"Show message under image?","type"=>"array","subType"=>"radio","values"=>array("Yes","No"),"scope"=>"module"),
				"message"=>array("id"=>"message","group"=>"Miscellaneous","order"=>"160","default"=>"Drag to spin the image","label"=>"Message under images","type"=>"text","scope"=>"module"),
