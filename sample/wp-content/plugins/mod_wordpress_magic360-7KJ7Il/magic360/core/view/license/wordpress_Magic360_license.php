<?php
    ...
    $plugin_version = plugin_get_version_WordPress_Magic360();
    $isKey = magictoolbox_WordPress_Magic360_get_data_from_db();
    $isScrollKey = false;
?>
<div class="license-container">
    ...
    <div class="magictoolbox-trial-box update-nag" style="width: 300px;    float: right;    display: inline-block;    margin-right: 45px; padding: 20px;">
        <a href="<?php echo WordPressMagic360_url('https://www.magictoolbox.com/buy/magic360/','license page buy your license link'); ?>" target="_blank" style="display: inline-block; lineheight: 0;"><img src="<?php echo $corePath; ?>/admin_graphics/magic360-trial-block.png" alt="" style="max-width: 100%;" /></a>
    </div>
    <?php } ?>
    <?php if (!$isKey) { ?>
    <div class="magictoolbox-trial-text">
        ...
        <p><a href="<?php echo WordPressMagic360_url('https://www.magictoolbox.com/buy/magic360/','license page buy your license link'); ?>" target="_blank" class="button button-primary orange-button">Buy my Magic 360 license &gt;</a></p>
        <p>
            ...
            <div style="position: relative; display: inline-block; vertical-alight: middle;">
                ...
                <div class="msg-wrapper">
                    ...
                    <div class="problem sad-message">
                        There was a problem with checking your license key. Please <a target="_blank" href="<?php echo WordPressMagic360_url('https://www.magictoolbox.com/contact/','license page problem contact link'); ?>">contact us</a>
                    </div>
                </div>
            </div>
        </div>
