<?php
    function WordPress_Magic360_wp_export($set="all", $core_sett, $constructor_sett) {
        ...
        $license = magictoolbox_WordPress_Magic360_get_data_from_db();
        if ($license) {
        ...
        $filename = $sitename . 'wordpress.magic360.' . date( 'Y-m-d' ) . '.xml';
