(function ($) {
    ...
    function importClick(e) {
        ...
        formData.append('action', 'WordPress_Magic360_import');
        formData.append('nonce', magictoolbox_WordPress_Magic360_admin_modal_object.nonce);
        ...
        xhr.open("POST", magictoolbox_WordPress_Magic360_admin_modal_object.ajax, true);
        xhr.send(formData);
    ...
    function exportClick(e) {
        ...
        f.attr('method', 'post');
        f.attr('action', magictoolbox_WordPress_Magic360_admin_modal_object.ajax);
        ...
        i.attr('type', 'hidden');
        i.attr('name', 'action');
        i.attr('value', 'WordPress_Magic360_export');
        f.append(i[0]);
        ...
        i.attr('type', 'hidden');
        i.attr('name', 'nonce');
        i.attr('value', magictoolbox_WordPress_Magic360_admin_modal_object.nonce);
        f.append(i[0]);
